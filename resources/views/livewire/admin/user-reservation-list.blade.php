        ...
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div class="overflow-hidden md:rounded-lg">
                <div class="flex space-x-4 sm:justify-between items-center mb-8">
                    <h2 class="text-2xl font-bold">{{ $user->name  }}'s Reservations</h2>
          ...
          <tr>
            <th scope="col" class="hidden lg:table-cell py-3.5 pl-6 pr-3 text-left text-xs lg:text-sm text-gray-900">
              Date
            </th>
            <th scope="col" class="lg:hidden py-3.5 pl-6 pr-3 text-left text-xs lg:text-sm text-gray-900">
              Date&Time
            </th>
            <th scope="col" class="hidden lg:table-cell py-3.5 pl-6 pr-3 text-left text-xs lg:text-sm text-gray-900">
                Client
        ...
        <tbody>
          ...
          <tr class="bg-white">
                ...
                <td class="pl-2 lg:hidden text-xs lg:text-sm sm:pl-6">
                    ...
                    <td class="hidden lg:table-cell py-4 pl-2 lg:pl-4 lg:pr-3 text-xs lg:text-sm sm:pl-6">
                    ...
                    <td class="pl-2 lg:hidden text-xs lg:text-sm sm:pl-6">
                        ...
                        {{ $reservation->course->name }}
                            <dl class="lg:hidden pt-2">
                                ...
                                <dd>{{ $reservation->location->meetingplace }}</dd>
                            </dl>
                    </td>
                    <td class="hidden lg:table-cell  py-4 pl-4 pr-3 text-xs lg:text-sm sm:pl-6">
                    ...
                    <div class="flex flex-col lg:flex-row items-center gap-3">
                        <button wire:click="sendIllnessMail({{ $reservation->id }})" class="px-2 py-1 text-white bg-red-500 rounded">
                            <i class="fas fa-medkit"></i>
                        </button>
                        <button wire:click="sendBadWeatherMail({{ $reservation->id }})"  class="px-2 py-1 text-white bg-blue-500 rounded">
                            <i class="fas fa-cloud"></i>
                        </button>
                        <a href="{{ route('user.reservation.edit', $reservation->id) }}" class="px-2 py-1 text-white bg-green-500 rounded">
